...
export default function Home() {
  ...
  <header id="mainNav" className="z-max cf fixed w-100 ph3 pv3 pv4-ns ph4-m ph5-l b bg-animate p-animate bb b--black-10 affix">
  ...
  <div className="cf">
    ...
    <div className="fl w-50 w-third-ns shadow-hover hide-child">
      <div className="child cf w-100 h-100 absolute bg-blue tc white f3">
  ...
  <section id="contact" className="vh-75 w-100 dt contact bg-near-white">
    <div className="dtc v-mid">
      ...
      <div className="pv4 ph3 tc">
        <a className="link blue hover-silver dib mh3 tc" href="mailto:feedback@tachyonstemplates.com?subject=feedback" title="email">
          <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <polyline points="22,6 12,13 2,6"></polyline>
        ...
        <a className="link blue hover-silver dib mh3 tc" href="tel:123-456-7899" title="GitHub">
          <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
